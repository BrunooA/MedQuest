...
class _ChatScreenState extends State<ChatScreen> {
  ...
  final List<Map<String, dynamic>> mensagens = [
    ...
    {"texto": "Você está podendo atender agora?", "isMe": true, "hora": "08:50"},
    {
      "texto": "Seu atendimento foi direcionado ao médico disponível. Aguarde, você será atendido em breve.",
      "isMe": false,
      "hora": "08:50"
    },
    {"texto": "Bom dia! estou sim!", "isMe": false, "hora": "08:50"},
    {"texto": "Em que posso te ajudar?", "isMe": false, "hora": "08:51"},
    {"texto": "Como você está se sentindo hoje?", "isMe": false, "hora": "08:51"},
    {
    ...
    {
      "texto": "Tenta descansar bastante, beber bastante água e, se a febre subir, pode usar um remédio pra ajudar.",
      "isMe": false,
      "hora": "08:56"
    },
    {
      "texto": "Fica atenta: se piorar, tiver falta de ar ou não melhorar em alguns dias, é importante procurar atendimento presencial, tá?\nVou encerrar por aqui, mas qualquer dúvida pode me chamar!",
      "isMe": false,
      "hora": "08:56"
    },
    ...
    {"texto": "Atendimento encerrado!", "isMe": false, "hora": "09:01", "isSystem": true},
  ];
        ...
        children: [
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) => _buildChatBubble(mensagens[index]),
            ),
          ),
          _buildInputArea(),
        ],
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      titleSpacing: 0,
      title: const Text("Dra. Anna Silva", style: TextStyle(color: Colors.white, fontSize: 16)),
      actions: [
        IconButton(
  ...
  Widget _buildChatBubble(Map<String, dynamic> msg) {
    ...
    if (isSystem) {
      return Center(
        child: Container(
          ...
          child: Text(msg['texto'], style: const TextStyle(color: Colors.white60, fontSize: 11)),
        ),
      );
    }
    ...
    return Align(
      ...
      child: Container(
        ...
        child: Text(msg['texto'] ?? '', style: TextStyle(color: isMe ? Colors.white : Colors.black)),
      ),
    );
  }
          ...
          FloatingActionButton.small(
            ...
            onPressed: () {
               if (_messageController.text.isNotEmpty) {
                 setState(() {
                   mensagens.add({"texto": _messageController.text, "isMe": true, "hora": "now"});
